$(function () {
  ...
  $(".a1").click(function () {
    iNow--;
    run(iNow);
    $("#calendar .calendar-bg").css("background-image", `url("images/${month}.jpg")`)
    $(".calendarImg").css("background-image", `url("images/${month}.jpg")`)
  });
  ...
  $(".a1").hover(function () {
    $(".left-circle").css("background-image", 'url("images/left-circle.png")')
  }, function () {
    $(".left-circle").css("background-image", 'url("images/left-circle1.png")')
  })

  $(".a2").hover(function () {
    $(".right-circle").css("background-image", 'url("images/right-circle.png")')
  }, function () {
    $(".right-circle").css("background-image", 'url("images/right-circle1.png")')
  })

  $(".home-btn").hover(function () {
    $(".home-btn").css("background-image", 'url("images/home.png")')
  }, function () {
    $(".home-btn").css("background-image", 'url("images/home1.png")')
  })
});